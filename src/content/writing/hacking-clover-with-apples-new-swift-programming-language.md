...
I experimented a bit with Apple’s new [Swift programming language](https://developer.apple.com/swift/) over the weekend and decided to try out accessing [Clover’s web services](https://www.clover.com/docs/web-api) (i.e. the stuff I work on during the day mostly) using Swift as a scripting language, more or less.  Based on this [tweet](https://twitter.com/clattner_llvm/status/474593140511211520) from [Chris Lattner](http://www.nondot.org/sabre/), I decided to try out a simple script for accessing point-of-sale order information via the Clover API.
